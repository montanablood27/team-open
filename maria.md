...
But can five-year-olds *really* learn calculus? "There's calculus, and then there's *calculus*," Maria jokes. "I don't think that children should be doing what undergrads in Calculus 101 are doing, and actually I don't think undergrads should be doing that either. But calculus is a view on the world. You can see how big things are made of small things and even infinitesimal things. You can make a circle out of straight lines --- the ancients knew that when they approximated circles with polygons. Kids play with this idea when they play with Legos, for example; they make a shape out of bricks. And that's a calculus idea in its nature."

If you download Natural Math's book *[Moebius Noodles](https://unglue.it/work/136397/)*, you'll find lots of exercises and lessons designed to reflect the way kids learn by playing. Activities feature toy bricks, crayons, chalk, and yes, even noodles. In all of her work, Maria stresses that play is at the root of learning. [As she said in an interview in the Atlantic](http://www.theatlantic.com/education/archive/2014/03/5-year-olds-can-learn-calculus/284124/), "What is learned without play is qualitatively different. It helps with test taking and mundane exercises, but it does nothing for logical thinking and problem solving."
