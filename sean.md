...
category: science
shortprofile: |
  When an earthquake struck Japan in 2011, avoiding hazardous areas was paramount. Within a month, Sean Bonner and Joi Ito formed the group Safecast to gather crowdsourced open sensor data. They created a system of up-to-date information on radiation zones in Japan, and using Creative Commons' public domain declaration (CC0), they then ensured "Absolutely no hindrance to using the data."
